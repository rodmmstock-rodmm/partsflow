...
class RoleAccess(UUIDMixin):
    ...
    can_view_po_balance = models.BooleanField(default=False)
    can_view_order_status = models.BooleanField(default=False)
    ...
    can_view_order_step = models.BooleanField(default=False)
