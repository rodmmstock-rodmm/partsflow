...
const NAV=[
 ["/","Stock","▦","can_view_dashboard"],["/history","History","↕","can_view_history"],["/safety-stock","Safety","!","can_view_safety_stock"],["/orders","Order","🛒","can_view_orders"],["/order-steps","Steps","▤","can_view_orders"],["/po-balance","PO","✉","can_view_orders"],["/fast-orders","Fast","⚡","can_view_orders"],["/vendors","Vendor","◫","can_view_suppliers"],["/machines","Machine","⚙","can_view_machines"],["/settings/roles","Roles","🔐","can_manage_roles"]
];
